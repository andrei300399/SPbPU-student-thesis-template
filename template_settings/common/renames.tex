...
\newcommand{\SupervisorJob}{ст. преподователь ВШПИ} %
...
\newcommand{\ConsultantNormDegree}{ст. преподователь ВШПИ} %   
%%% Первый консультант
...
\newcommand{\ConsultantExtraDegree}{ст. преподователь ВШПИ} % 
